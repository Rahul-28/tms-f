...
public class CustomerAsserts {
    ...
    public static void assertCustomerUpdatableFieldsEquals(Customer expected, Customer actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getAadhaarNumber()).as("check aadhaarNumber").isEqualTo(expected.getAadhaarNumber()))
            .satisfies(a -> assertThat(a.getAddress()).as("check address").isEqualTo(expected.getAddress()))
            .satisfies(a -> assertThat(a.getContactInformation()).as("check contactInformation").isEqualTo(expected.getContactInformation())
            )
