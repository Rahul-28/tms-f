...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '1c304f2c-01c5-4873-b396-f7c36ecb2e1f' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('df40abf8-2b02-440b-8b94-a56342d3ced0');
      cy.get(`[data-cy="name"]`).should('have.value', 'df40abf8-2b02-440b-8b94-a56342d3ced0');
