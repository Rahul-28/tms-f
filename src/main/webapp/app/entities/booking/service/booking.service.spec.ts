...
const requireRestSample: RestBooking = {
  ...
  travellingDate: sampleWithRequiredData.travellingDate?.format(DATE_FORMAT),
  boardingTime: sampleWithRequiredData.boardingTime?.toJSON(),
