...
import { sampleWithRequiredData } from '../train.test-samples';
...
describe('Train Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.trains()[0]).toEqual(expect.objectContaining({ id: 7549 }));
  });

  describe('trackId', () => {
    it('should forward to trainService', () => {
      const entity = { id: 7549 };
      jest.spyOn(service, 'getTrainIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTrainIdentifier).toHaveBeenCalledWith(entity);
